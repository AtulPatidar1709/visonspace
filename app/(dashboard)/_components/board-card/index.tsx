...
export const BoardCard = ({
    ...
    return (
        <Link prefetch={false} href={`/board/${id}`}>
            <div className="group aspect-[3/4] border rounded-lg flex flex-col justify-between overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-200">
