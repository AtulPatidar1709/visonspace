...
import { colorToCss, connectionIdToColor, findIntersectingLayersWithRectangle, penPointsToPathLayer, pointerEvnetToCanvasPoint, resizeBounds } from "@/lib/utils";
...
export const Canvas = ({ boardId }: CanvasProps) => {
    ...
    }, [canvasState, startMultiSelection, updateSelectionNet, translateSelectedLayers, continueDrawing, resizeSelectedLayer, camera]);
            ...
            >
                ...
                >
                    ...
                    {canvasState.mode === CanvasMode.SelectionNet && canvasState.current != null && (
                        <rect
                            className="fill-red-500 opacity-15 stroke-1"
